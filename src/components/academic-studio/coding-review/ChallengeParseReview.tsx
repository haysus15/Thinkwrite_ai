...
export default function ChallengeParseReview({
  ...
  return (
    <section className="space-y-3 rounded-xl border border-white/10 bg-slate-900/40 p-4">
      <header>
        <h3 className="text-sm font-medium text-slate-100">Review parsed challenges</h3>
        <p className="mt-1 text-xs text-slate-400">
          Edit, delete, reorder, or add missing challenges before saving.
        </p>
      </header>
      ...
      <div className="flex items-center justify-end gap-2">
        ...
        >
          {isSaving ? "Saving..." : "Confirm challenges"}
        </button>
      </div>
    </section>
  );
