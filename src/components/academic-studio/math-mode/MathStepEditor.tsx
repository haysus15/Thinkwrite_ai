  ...
  return (
    <div className="rounded-xl border border-white/10 bg-slate-950/70 p-3.5">
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="rounded-lg border border-sky-400/40 bg-sky-500/15 px-2.5 py-1 text-xs text-sky-200 disabled:cursor-not-allowed disabled:opacity-50"
          >
            Verify
          </button>
          <button
      ...
      <textarea
        ...
        rows={2}
        className="mt-3 w-full rounded-lg border border-white/10 bg-white/[0.03] px-3 py-2 text-xs text-slate-100 placeholder:text-slate-500"
      />
