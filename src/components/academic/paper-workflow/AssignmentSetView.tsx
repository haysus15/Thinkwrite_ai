...
export default function AssignmentSetView({ setId }: { setId: string }) {
  const t = useTranslations("academic.paperWorkflow.setView");
  ...
  return (
    <div className="space-y-4">
      <header className="space-y-3 rounded-xl border border-white/10 bg-slate-900/40 p-4">
        ...
        {setData.rubric_text && (
          <details className="rounded border border-white/10 p-3">
            <summary className="cursor-pointer text-xs text-slate-300">{t("viewRubric")}</summary>
        ...
        <div>
          <p className="text-xs text-slate-300">
            {t("progress", { complete: completedCount, total: papers.length })}
          </p>
