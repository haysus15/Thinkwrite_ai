// src/components/academic/travis-sidebar/TravisSidebar.tsx
"use client";
...
export default function TravisSidebar() {
  const t = useTranslations("academic.travisUi.sidebar");
  ...
  const publishReviewedSyllabusWithErrors = async () => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : t("errors.approvePublishFailed"));
    }
  };
