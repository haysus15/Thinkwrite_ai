...
export function useCodingLearningActions(args: UseCodingLearningActionsArgs) {
  ...
  }, [activePathId, activePathTitle, code, currentLesson, language, onOpenStudyHub, outputLanguage, setCreatingStudyGuide, setError, setToast, struggleTopics]);
  ...
  }, [activePathId, activeProgress, checkpointExplain, checkpointModify, codingReviewSessionId, code, handleMarkLessonComplete, language, output, outputLanguage, setCheckpointError, setCheckpointExplain, setCheckpointFeedback, setCheckpointModify, setCheckpointOpen, setCheckpointReviewing, setToast]);
  ...
  }, [code, coachingProfile, conversationId, currentLesson, language, output, outputLanguage, setAssistError, setAssistLoading, setAssistResponse, setConversationId, setTeachingCurrentStepIndex, setTeachingLoading, setTeachingSessionId, setTeachingSteps]);
